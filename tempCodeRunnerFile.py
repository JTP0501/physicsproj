...
# Text input
PMassInput = pygame_gui.elements.UITextEntryLine(relative_rect=pygame.Rect((43, 65), (98, 22)), manager=MANAGER, object_id="#PullyMass")
PRadiusInput = pygame_gui.elements.UITextEntryLine(relative_rect=pygame.Rect((43, 113), (98, 22)), manager=MANAGER, object_id="#PullyRadius")
WMassInput = pygame_gui.elements.UITextEntryLine(relative_rect=pygame.Rect((43, 161), (98, 22)), manager=MANAGER, object_id="#WeighMass")
DurationInput = pygame_gui.elements.UITextEntryLine(relative_rect=pygame.Rect((43, 210), (98, 22)), manager=MANAGER, object_id="#DropDuration")
...
while running:
    ...
    if started:
        ...
        if weight_y > height:
            scaled_weight_x = mini_screen_x + 75 - weight_width // 2
            scaled_weight_y = mini_screen_y + weight_scaley

            if scaled_weight_y < mini_screen_y + mini_screen_height:
                pygame.draw.line(screen, (83, 56, 71), (mini_screen_x + 75, mini_screen_y), (scaled_weight_x + weight_width // 2, scaled_weight_y), 2)
                pygame.draw.rect(screen, (83, 56, 71),
                                 (scaled_weight_x - weight_second_border_thickness, scaled_weight_y - weight_second_border_thickness,
                                  weight_width * 3 + 2 * weight_second_border_thickness,
                                  weight_height * 3 + 2 * weight_second_border_thickness))
                pygame.draw.rect(screen, WHITE,
                                 (scaled_weight_x - weight_border_thickness, scaled_weight_y - weight_border_thickness,
                                  weight_width * 3 + 2 * weight_border_thickness,
                                  weight_height * 3 + 2 * weight_border_thickness))
                pygame.draw.rect(screen, (223, 98, 26), (scaled_weight_x, scaled_weight_y, weight_width * 3, weight_height * 3))
